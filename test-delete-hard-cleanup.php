<?php
// Appel POST à delete.php avec mode=hard_cleanup
if ($argc < 2) { echo "Usage: php test-delete-hard-cleanup.php <id>\n"; exit(1); }
$id = intval($argv[1]);
$opts = [ 'http' => [ 'method' => 'POST', 'header' => "Content-Type: application/x-www-form-urlencoded\r\n", 'content' => http_build_query(['id'=>$id,'mode'=>'hard_cleanup']), 'ignore_errors'=>true ] ];
